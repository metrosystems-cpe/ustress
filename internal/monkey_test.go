...
var (
	...
	workers = []WorkerConfig{
		...
		{Request: 4, Status: 0, Thread: 2, Duration: 0.001074489, Error: "Get https://idamm.metrosystems.net/.well-known/openid-configuration: dial tcp: lookup idamm.metrosystems.net: no such host", mkcfg: mkcfg},
		{Request: 5, Status: 0, Thread: 1, Duration: 0.000819102, Error: "Get https://idamm.metrosystems.net/.well-known/openid-configuration: dial tcp: lookup idamm.metrosystems.net: no such host", mkcfg: mkcfg},
		...
		{Request: 9, Status: 0, Thread: 1, Duration: 0.001170958, Error: "Get https://idamm.metrosystems.net/.well-known/openid-configuration: dial tcp: lookup idamm.metrosystems.net: no such host", mkcfg: mkcfg},
		{Request: 10, Status: 0, Thread: 3, Duration: 0.001052171, Error: "Get https://idamm.metrosystems.net/.well-known/openid-configuration: dial tcp: lookup idamm.metrosystems.net: no such host", mkcfg: mkcfg},
